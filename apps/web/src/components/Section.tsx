...
export const SectionTitle: React.FC<React.PropsWithChildren<Props>> = ({ children, id, className }) => <h2 id={id} className={classNames('text-4xl sm:text-6xl font-odir-header font-black mb-4', className)}>{children}</h2>;
